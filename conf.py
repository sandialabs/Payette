...
project = u'Payette'
copyright = u'2012, Tim Fuller, Scot Swan'
...
latex_documents = [
  ('index', 'Payette.tex', u'Payette Documentation',
...
man_pages = [
    ('index', 'payette', u'Payette Documentation',
...
texinfo_documents = [
  ('index', 'Payette', u'Payette Documentation',
   u'Tim Fuller, Scot Swan', 'Payette', 'One line description of project.',
   'Miscellaneous'),
]
