...
Payette_test = True
name = 'kayenta-ctps-txei'
keywords = ['kayenta','medium','verification','ctps','txe']
owner = 'Tim Fuller'
date = 'June 26, 2011'
...
description = '''
    triaxial extension with the kayenta material

    baseline file is derived from an equivalent simulation run in the MED
'''
