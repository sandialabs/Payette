...
Payette_test = True
name = 'kayenta-isotropic-compression'
keywords = ['kayenta','medium','isotropic compression','verification','hardening']
owner = "Tim Fuller"
date = 'June 25, 2011'
...
description = '''
      Test isotropic compression of kayenta material

      baseline file is from equivalent MED simulation
