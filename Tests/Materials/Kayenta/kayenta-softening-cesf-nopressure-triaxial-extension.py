...
class Test(PayetteTest):
   ...
   proportional loading (constant ratio of stresses) defined by:
       Stress Triaxiality = -1.0 = sigma_m / sigma_eqv = I1/(3*ROOT3*ROOTJ2)
       Lode Parameter = 1.0 = sin(3\lodeangle)
   which correlate to a state of triaxial extension that is an overall
   compressive state.
