...
Payette_test = True
name = 'kayenta-deviatoric-shear-with-isotropic-strain'
keywords = ['kayenta','prototype','fast','hardening']
owner = 'Tim Fuller'
date = 'June 28, 2011'
...
description = '''
   Deviatroic shear strain with superimposed isotropic strain
'''
