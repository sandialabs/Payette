...
Payette_test = True
name = 'kayenta-pure-shear-w-lin-hardening'
keywords = ['kayenta','fast','verification','hardening']
owner = 'Tim Fuller'
date = 'June 26, 2011'
...
description = '''
    Kayenta material, pure shear loading with linear hardening

    baseline file derived from equivalent simulation performed in the MED
'''
