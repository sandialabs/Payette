...
Payette_test = True
name = 'kayenta-sandler-rubin'
keywords = ['kayenta','fast','sandler rubin','verification']
owner = 'Tim Fuller'
date = 'June 26, 2011'
...
description = '''
    Sandler-Rubin problem from MED benchmarks

    baseline file derived from output of MED simulation for same problem
'''
