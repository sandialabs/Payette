...
Payette_test = True
name = 'kayenta-dtraatcd-multileg-biaxial-plane-stress'
keywords = ['kayenta','verification','dtraatcd','fast']
owner = 'Tim Fuller'
date = 'June 26, 2011'
...
description = '''
    Comparison with DTRA ATCD multileg biaxial plane stress test

    baseline file is from an equivalent MED simulation.
'''
