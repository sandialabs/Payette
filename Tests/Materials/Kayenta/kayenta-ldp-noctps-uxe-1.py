...
class Test(PayetteTest):
    ...
    def __init__(self, check=True):
        ...
        self.description = """This simulation has the following characteristics:
 * The shear modulus was calculated from the bulk modulus of aluminum
   and a poisson's ratio of zero.
 ...
 * The limit surface has been set to mimic the CTPS surface when
 ...
 the return algorithm should always return it back to where it was at the
